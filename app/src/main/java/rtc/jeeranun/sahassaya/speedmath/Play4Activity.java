...
public class Play4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rabbit3ImageView = (ImageView) findViewById(R.id.imageView34sp3);
        rabbit4ImageView = (ImageView) findViewById(R.id.imageView34sp2);
        rabbit5ImageView = (ImageView) findViewById(R.id.imageView33);
        rabbit6ImageView = (ImageView) findViewById(R.id.imageView34sp1);
        rabbit7ImageView = (ImageView) findViewById(R.id.imageView34);
