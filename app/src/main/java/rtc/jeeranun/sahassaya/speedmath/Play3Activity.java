...
public class Play3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ch1TextView = (TextView) findViewById(R.id.textView18);
        ch2TextView = (TextView) findViewById(R.id.textView17);
        ...
        rabbit1ImageView = (ImageView) findViewById(R.id.imageView22sp2);
        rabbit2ImageView = (ImageView) findViewById(R.id.imageView22);
        rabbit3ImageView = (ImageView) findViewById(R.id.imageView22sp1);
        rabbit4ImageView = (ImageView) findViewById(R.id.imageView23);
        rabbit5ImageView = (ImageView) findViewById(R.id.imageView24);
        rabbit6ImageView = (ImageView) findViewById(R.id.imageView25);
        rabbit7ImageView = (ImageView) findViewById(R.id.imageView26);
