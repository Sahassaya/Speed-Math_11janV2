...
public class Play5Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rabbit1ImageView = (ImageView) findViewById(R.id.imageView38sp3);
        rabbit2ImageView = (ImageView) findViewById(R.id.imageView39);
        rabbit3ImageView = (ImageView) findViewById(R.id.imageView38sp2);
        rabbit4ImageView = (ImageView) findViewById(R.id.imageView40);
        rabbit5ImageView = (ImageView) findViewById(R.id.imageView38sp1);
        rabbit6ImageView = (ImageView) findViewById(R.id.imageView38);
        rabbit7ImageView = (ImageView) findViewById(R.id.imageView41);
